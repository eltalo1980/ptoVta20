...
<div class="container my-5">
      ...
      <section class="">
        <section id="demo" class="">
          <strong class="text-danger">Devolucion {{Auth::user()->nombres}} {{Auth::user()->apellidos}}</strong>
            <div class="row">
            ...
            @if(isset($totalTmp) )
                <a class="btn btn-success btn-rounded btn-lg" href="javascript:fncDevolucion(1)">Devolucion</a>
            @endif
            ...
            <br>
                ...
                <form class="form-horizontal" name="form1" id="form1" method="POST" action="">
                    @csrf
                    <h1 class="text-danger">Codigo Devolución<input type="text" name="codigo" id="codigo" onkeypress="fncBuscaProducto(event)" autofocus></h1>
...
function fncAceptaProducto(codigo)
{
    ...
    document.getElementById("form1").action="{{ route('Devolucion.store') }}";
    document.getElementById("form1").submit();
}
