					...
					<div class="table-container">
                        ...
                        <form action="{{ route('stock.update',$ProductoEditar[0]->id_producto) }}" method="POST" name="form1">
                            ...
                            @method('PUT')
								...
								<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6"><div class="form-group"><strong>cantidad_venta_mayor:</strong><input id="cantidad_venta_mayor" type="text" name="cantidad_venta_mayor" value="{{ ($ProductoEditar[0]->cantidad_venta_mayor >0 ) ? $ProductoEditar[0]->cantidad_venta_mayor : 0 	}}" class="form-control" ></div></div>
								</div>
								<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6"><div class="form-group"><strong>Precio venta mayor:</strong><input id="precio_venta_mayor" type="text" name="precio_venta_mayor" value="{{ ($ProductoEditar[0]->precio_venta_mayor >0 ) ? $ProductoEditar[0]->precio_venta_mayor : 0 }}" class="form-control" ></div></div>
								</div>
									<div class="row">
									<div class="col-xs-6 col-sm-6 col-md-6">
										<div class="form-group">
											...
											<select id="venta_por_unidad" name="venta_por_unidad" class="form-control">
												@if($ProductoEditar[0]->venta_por_unidad==0 || $ProductoEditar[0]->venta_por_unidad=="" )
