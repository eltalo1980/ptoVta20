		...
		<div class="col-md-8 col-md-offset-2">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Ingresar  Producto</h3>
				</div>
					...
					<div class="table-container">
                        ...
                        <form action="{{ route('stock.update',$ProductoEditar[0]->id_producto) }}" method="POST" name="form1">
                            ...
                            @method('PUT')
								...
								<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6"><div class="form-group"><strong>Precio costo:   </strong><input id="precio_costo" type="money" name="precio_costo" value="{{ str_replace('.','',$ProductoEditar[0]->precio_costo) }}" class="form-control" onkeypress="fncCalulaPrecioVenta()" onchange="fncCalulaPrecioVenta()"></div></div>
								</div>
								<div class="row">
								...
								<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6"><div class="form-group"><strong>Porcentaje:   </strong><input id="porcentaje" type="number" name="porcentaje" value="{{$ganacia}}" class="form-control" onkeypress="fncCalulaPrecioVenta()" onchange="fncCalulaPrecioVenta()"  ></div></div>
								</div>
								<div class="row">
